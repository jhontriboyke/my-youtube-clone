import { BellIcon, CameraIcon, MenuIcon, SearchIcon } from 'lucide-react';
...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex justify-between p-4 sticky top-0 bg-black">
            <div className="flex flex-row gap-4 items-center">
                <button className="p-1 hover:bg-neutral-500/50 rounded-full grid place-items-center w-10 h-10">
                    <MenuIcon className="w-6" />
                </button>
                <Link className="fill-white" to={'/home'}>
                    <svg
                ...
                <div>
                    <form className="flex flex-row" onSubmit={handleSubmit}>
                        <input
                            ...
                            type="text"
                            placeholder="Search"
                            className="sm:w-full px-4 py-1.5 outline-none bg-transparent border-[.5px] border-neutral-700 rounded-l-full"
                        />
                        <button
                            type="submit"
                            className="bg-neutral-700 pl-3 pr-5 rounded-r-full"
                            title="Search"
                        >
